...
import (
	...
	frameworkfake "github.com/koordinator-sh/koordinator/pkg/descheduler/framework/fake"
...
func TestHighNodeUtilization(t *testing.T) {
	...
	testCases := []struct {
		name                string
		thresholds          deschedulerconfig.ResourceThresholds
		nodes               []*v1.Node
		pods                []*v1.Pod
	...
	for _, testCase := range testCases {
		t.Run(testCase.name, func(t *testing.T) {
			...
			f, err := frameworkruntime.NewFramework(registryClone, tt.profile,
			...
			plugin, err := NewHighNodeUtilization(&deschedulerconfig.HighNodeUtilizationArgs{
